---
layout: post
title: "Innie Speaks (Part 2)"
date: 2026-07-07 23:05:00 +0800
tags: [unsevered]
---
...
Annual performance reviews happen at the EOY, where the direct manager evaluates an entire year's work and hands down a final grade (I’m sorry, where?). On the other hand, mid-year goal-setting can trigger compensation adjustments, which are evaluated against the following criteria:

1. Past overall performance
2. Future potential: admittedly, hard to quantify
3. Market competition: I wonder what that’s based on for e-s
